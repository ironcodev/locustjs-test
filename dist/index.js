  ...
  return _createClass(Test, [{
    ...
    value: function run() {
      ...
      return new Promise(function (res) {
        var start = new Date();
        if ((0, _base.isFunction)(_this.fn)) {
  ...
  return _createClass(TestRunner, [{
        ...
        if (tests) {
          ...
          if ((0, _base.isArray)(tests)) {
            var _tests = tests.map(function (test) {
              ...
              return _this2._runSingle(test, onProgress, i);
            });
            Promise.all(_tests).then(function (_) {
              return res(_this2.result);
            })["catch"](function (ex) {
              _this2._errors.push({
                err: new TestException({
    ...
    value: function report(detailed) {
      ...
      var _loop = function _loop() {
        var testResult = _this3._results[i];
        var t = "(".concat(_this3._getTime(testResult.time), ")");
        if (detailed) {
          var message = "\n" + (i + 1) + ". ";
    ...
    key: "test",
    value: function () {
      var _test2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _ref;
        var lastArg,
          detailed,
          _tests,
